<template>
    <div>
        <div class="category">
            <NavBread>
                <a slot="link" href="javascript: void(0);">{{ name }}</a>
            </NavBread>
            <div class="bloglist">
                <div class="newblog">
                    <ul>
                    ...
                    <figure><img src="~assets/img/category/001.jpg"></figure>
        ...
        <aside>
            <div class="rnav">
                <li class="rnav1 "><a href="javascript: void(0);">日记</a></li>
                <li class="rnav2 "><a href="javascript: void(0);">欣赏</a></li>
                <li class="rnav3 "><a href="javascript: void(0);">程序人生</a></li>
                <li class="rnav4 "><a href="javascript: void(0);">经典语录</a></li>
            </div>
            <div class="ph_news">
                <h2>
                    <p>点击排行</p>
                ...
                <ul class="pl_n">
                    <dl>
                        <dt><img src="~assets/img/category/s8.jpg"> </dt>
                        <dt> </dt>
                        <dd>DanceSmile
                            <time>49分钟前</time>
                        </dd>
                    ...
                    <dl>
                        <dt><img src="~assets/img/category/s7.jpg"> </dt>
                        <dt> </dt>
                        <dd>yisa
                            <time>2小时前</time>
                        </dd>
                    ...
                    <dl>
                        <dt><img src="~assets/img/category/s6.jpg"> </dt>
                        <dt> </dt>
                        <dd>小林博客
                            <time>8月7日</time>
                        </dd>
                    ...
                    <dl>
                        <dt><img src="~assets/img/category/003.jpg"> </dt>
                        <dt> </dt>
                        <dd>DanceSmile
                            <time>49分钟前</time>
                        </dd>
                    ...
                    <dl>
                        <dt><img src="~assets/img/category/002.jpg"> </dt>
                        <dt> </dt>
                        <dd>yisa
                            <time>2小时前</time>
                        </dd>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods: {
            loadingArticles () {
                axios.get('/categories/articleList', {
                    params: {
